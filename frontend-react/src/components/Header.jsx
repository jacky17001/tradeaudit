...
const pageTitleKeys = {
  ...
  '/portfolio': 'pageTitles.portfolioView',
  '/follow-up-tasks': 'pageTitles.followUpTasks',
  '/report-snapshots': 'pageTitles.snapshotHistory',
  ...
  '/review-board': 'pageTitles.reviewBoard',
  '/audit-cases': 'pageTitles.auditCases',
